...
2. Install Python development tools, for Fedora it's a single command.
    Command: sudo dnf groupinstall "Development Tools"
3. Make sure you have everything installed.
    Command: sudo dnf install gcc openssl-devel bzip2-devel libffi-devel
4. Let's check.
    Command: make --version && gcc --version && g++ --version
5. Download the supported Python version from the official website. For me v3.7.16 worked well.
6. Extract the file, for linux terminal use the command below.
    Command: tar -xf Python-3.7.16.tgz
7. Go into the extracted directory
    Command: cd Downloads/Python-3.7.16/
9. Let's configure.
    Command: ./configure --enable-optimizations --with-ensurepip=install
10. Now preparation.
     Command: make -j 8
11. And install, this command will install your Python version next to the main one.
     Command: sudo make altinstall
12. Create a directory for your project and go there.
     Command: mkdir ~/parking_project && cd ~/parking_project
13. Create virtual environment there, the last word is how you name it.
     Command: mkdir ~/parking_project && python3.7 -m venv venv_3_7
14. Download this repo or use git clone command. After extracting you can move everything to your project directory.
15. Activate your new Python venv. 
     Command: source venv_3_7/bin/activate
16. Verify you are using the correct version.
     Command: python -VV
16. Download required modules.
     Command: pip3 install -r requirements.txt
17. It won't run because of protobuf. Download it as the error is suggesting, for me it was:
     Command: pip install protobuf==3.20.*
18. Run test.py first to make sure everything is working, you will need graphical module for it.
