...
while video_capture.isOpened():
    ...
    if parked_car_boxes is None:
        ...
        for box in parked_car_boxes:
            print("Көлік тұрағының координаттары: ", box)
            total_car_boxes += 1
        print(f'Жалпы {total_car_boxes} көлік тұрағы бар.')
        ...
        if free_space_frames > 6:
            # Write SPACE AVAILABLE!! at the top of the screen
            
            print(f"Босаған көлік тұрағының саны {free_parking_space}.")
